...
*朱码 JS 解析器*是为*朱码*量身定制的一款解析器，基于原生 JavaScript（Vanilla JS）开发，无需任何第三方库即可将符合*朱码*语法的文本解析输出为 HTML 格式。*朱码 JS 解析器*支持*朱码*的全部语法规则，请查看[朱码](https://github.com/drewneon/drewmark)的文档了解详细的语法规则。
